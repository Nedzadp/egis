 ...
 * @author Nedzad
 */
public class InformationMenuBarCommand extends AbstractCommand{

    public InformationMenuBarCommand(LayoutController layoutController) {
    ...
    public void menuSelected(MenuBar.MenuItem selectedItem) {
        ...
        CustomPanelLayout layout = new MainContentInformationLayout(getLayoutController());
        layout.initLayout();
