 ...
 * @author Nedzad
 */
public class MainContentInformationLayout extends CustomPanelLayout{

    public MainContentInformationLayout(LayoutController layoutController) {
   ...
   @Override
    public void initLayout() {
        ...
        if(getLayoutController().getI18n().getLanguageEnum().getLang().equals("eng")) {
            layout.addComponent(new CustomLayout("information_eng"));
