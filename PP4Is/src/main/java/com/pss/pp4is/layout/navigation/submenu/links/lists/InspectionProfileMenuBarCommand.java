 ...
 * @author Nedzad
 */
public class InspectionProfileMenuBarCommand extends AbstractCommand{

    public InspectionProfileMenuBarCommand(LayoutController layoutController) {
        super(layoutController);
    }

    @Override
    public void menuSelected(MenuBar.MenuItem selectedItem) {
        CustomPanelLayout layout = new MainContentInspectionProfileLayout(getLayoutController());
        layout.initLayout();
