 ...
 * @author Nedzad
 */
public class SystemUsageMenuBarCommand extends AbstractCommand{

    public SystemUsageMenuBarCommand(LayoutController layoutController) {
    ...
    public void menuSelected(MenuBar.MenuItem selectedItem) {
        ...
        CustomPanelLayout layout = new MainContentSystemUsageLayout(getLayoutController());
        layout.initLayout();
