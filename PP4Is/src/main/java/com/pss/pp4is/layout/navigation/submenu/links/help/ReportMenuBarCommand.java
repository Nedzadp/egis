 ...
 * @author Nedzad
 */
public class ReportMenuBarCommand extends AbstractCommand{

    public ReportMenuBarCommand(LayoutController layoutController) {
        super(layoutController);
    }

    @Override
    public void menuSelected(MenuBar.MenuItem selectedItem) {
        CustomPanelLayout layout = new MainContentReportsLayout(getLayoutController());
        layout.initLayout();
