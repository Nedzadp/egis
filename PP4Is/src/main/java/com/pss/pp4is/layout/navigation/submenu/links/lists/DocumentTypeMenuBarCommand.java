 ...
 * @author Nedzad
 */
public class DocumentTypeMenuBarCommand extends AbstractCommand {

    public DocumentTypeMenuBarCommand(LayoutController layoutController) {
    ...
    public void menuSelected(MenuBar.MenuItem selectedItem) {
        ...
        CustomPanelLayout layout = new MainContentProductTypeLayout(getLayoutController());
        layout.initLayout();
